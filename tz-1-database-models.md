...
> **Дисклеймер**: Данный документ носит **рекомендательный характер**. Конечную структуру таблиц каждого микросервиса проектирует и утверждает разработчик, ответственный за этот сервис. Приведённые ниже схемы — это отправная точка и ориентир для обеспечения согласованности между сервисами.
