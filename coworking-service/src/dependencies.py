...
if settings.use_mocks:
    ...
    _mock_coworking_repo = MockCoworkingRepository()
    _mock_booking_repo = MockBookingRepository()

    def get_coworking_repository():
        return _mock_coworking_repo

    def get_booking_repository():
        return _mock_booking_repo
...
def get_coworking_service(
    coworking_repo=Depends(get_coworking_repository),
